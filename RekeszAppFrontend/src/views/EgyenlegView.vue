...
<style scoped>
.konyveles-card,.rekesz-card{margin-bottom:18px}.konyveles-head{display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;margin-bottom:14px}.datumsav{display:flex;gap:12px}.datumsav label,.rr-datum{display:flex;flex-direction:column;gap:3px;font-size:12px;font-weight:600;color:var(--olive);text-transform:uppercase}.datumsav input,.rr-datum input{padding:6px 8px}.stat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:14px}.stat{background:var(--chalk-green);color:var(--paper);border-radius:10px;padding:14px 12px;text-align:center}.stat .val{font-family:monospace;font-size:19px;font-weight:700}.stat .lbl{font-size:11.5px;text-transform:uppercase;letter-spacing:.06em;opacity:.85;margin-top:3px}.stat.accent{background:var(--kapia)}.stat.olive{background:var(--olive)}.reszletek{font-size:13px;line-height:1.7;margin-bottom:12px}.figyelmeztetes{color:var(--owe);font-weight:600}.zoldseg-tabla{font-size:13px}.rr-hint{margin:-6px 0 12px}.rr-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));gap:10px}.rr-tile{background:var(--chalk-green);color:var(--paper);border-radius:10px;padding:12px 14px;display:flex;flex-direction:column;gap:4px}.rr-tipus{font-size:12.5px;text-transform:uppercase;letter-spacing:.05em;opacity:.88}.rr-szamok{font-family:monospace;font-size:20px;font-weight:700}
.egyenleg-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px}.wide{grid-column:1/-1}.egyenleg-card h2{margin-bottom:12px}.partner-block{border:1px solid var(--line);border-radius:10px;padding:10px 12px;margin-bottom:9px;cursor:pointer;background:var(--surface-soft)}.partner-block:hover{background:var(--surface-soft-strong)}.partner-name{font-weight:800;color:var(--chalk-green);font-size:16px;margin-bottom:6px}.balance-row{display:grid;grid-template-columns:1fr auto auto;gap:12px;align-items:center;padding:4px 0;font-family:monospace}.crate{font-weight:700}.db{white-space:nowrap}.money{font-weight:800;text-align:right;color:var(--owe);white-space:nowrap}.partner-total{border-top:1px solid var(--line);margin-top:6px;padding-top:6px;text-align:right;font-size:12.5px;color:var(--olive)}
...
.overlay{position:fixed;inset:0;background:rgba(35,38,32,.55);display:flex;align-items:center;justify-content:center;z-index:100;padding:14px}.modal{background:var(--paper,#F7F3E8);border-radius:12px;width:100%;max-width:720px;max-height:90vh;overflow:auto;padding:18px}.modal-head{display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:14px}.modal-head h3{margin:0;color:var(--chalk-green);font-size:19px}.modal-sub{font-size:12px;color:var(--olive);text-transform:uppercase;letter-spacing:.05em;margin-top:3px}.close{border:0;background:none;font-size:18px;color:var(--olive);cursor:pointer}.modal-crate-group{margin-bottom:16px}.modal-crate-title{font-weight:800;color:var(--chalk-green);border-bottom:2px solid var(--line);padding-bottom:5px;margin-bottom:7px}.tetel-card{border:1px solid var(--line);border-radius:10px;padding:10px;margin-bottom:7px;background:var(--surface-soft)}.tetel-top{display:grid;grid-template-columns:1fr auto auto;gap:12px;align-items:center}.tetel-top b{color:var(--owe);white-space:nowrap}.tetel-controls{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-top:8px;font-size:12.5px}.tetel-controls label:first-child{display:flex;align-items:center;gap:5px}.tetel-controls input[type=number]{width:68px;padding:5px}.check{display:flex;align-items:center;gap:4px;white-space:nowrap}.save-small{border:0;border-radius:7px;padding:6px 10px;background:var(--chalk-green);color:var(--paper);cursor:pointer;font-weight:700}.save-small:disabled{opacity:.55}.modal-summary{border-top:2px solid var(--line-strong);padding-top:12px;margin-top:8px}.summary-row{display:grid;grid-template-columns:1fr auto auto;gap:14px;font-family:monospace;padding:3px 0}.summary-row span:last-child{text-align:right;color:var(--owe)}.summary-total{display:grid;grid-template-columns:1fr auto auto;gap:14px;border-top:1px solid var(--line);margin-top:6px;padding-top:7px;font-family:monospace}.summary-total strong{color:var(--owe)}
